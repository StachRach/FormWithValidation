...
class App extends Component {
    ...
    messages = {
        username_incorrect: "Nazwa musi zawierać od 4 do 15 znaków i nie może zawierać spacji.",
    ...
    formValidation = () => {
        ...
        if(this.state.username.length > 4 && this.state.username.length < 15 && this.state.username.indexOf(" ") === -1) {
            username = true
        }
            ...
            <div>
                <form onSubmit={this.handleSubmit} noValidate>
                    ...
                    <label htmlFor="password">Twoje hasło:
                        <input className="inp" type="password" id="password" name="password"
